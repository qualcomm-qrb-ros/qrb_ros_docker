...
HOST_FILES+=("-v ${HOST_INCLUDE_PATH}/GenieCommon.h:${CONTAINER_INCLUDE_PATH}/GenieCommon.h")
HOST_FILES+=("-v ${HOST_INCLUDE_PATH}/GenieDialog.h:${CONTAINER_INCLUDE_PATH}/GenieDialog.h")
...
HOST_FILES+=("-v ${HOST_INCLUDE_PATH}/System/*:${CONTAINER_INCLUDE_PATH}/Syetem/*")
